...
lint: lint-dotenv lint-markdowns lint-shells lint-yamls lint-dockerfile lint-makefile lint-jsons lint-files lint-helm-chart lint-npm
...
format: format-files format-shells format-markdowns format-npm
